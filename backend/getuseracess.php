...
$allowedRoutes = [
        ...
        'responsable' => ['/responsable','/responsable/brh', '/responsable/dashboard','/responsable/add','/responsable/notifications','/responsable/projects','/responsable/map','/responsable/profile'],
